...
public class InMemoryTaskManagerTest {
    ...
    public void init() {
        ...
        epic = new Epic(taskManager.getTaskId(), Type.EPIC, "Epic", "Description Epic", Status.NEW, new ArrayList<>());
        taskManager.createEpic(epic);
        subTask = new SubTask(taskManager.getTaskId(), Type.SUBTASK, "Subtask, Epic", "Description Sub Ep", Status.NEW, epic.getId());
    ...
    public void manualAndAutoGeneratedIdsDoNotConflict() {
        ...
        Task manualTask = new Task(manualId, Type.TASK, "manualTask", "Description", Status.NEW);
